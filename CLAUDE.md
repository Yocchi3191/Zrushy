...
- zrushyに関する質問・相談をした際は、必ず関連するファイルを確認してからレスポンスするようにしてください
- ユーザーから行動の指摘・修正を受けたとき（「〜するようにしてください」「〜しないでください」等）は、その場でこのCLAUDE.mdに追記して次回から同じ指摘が不要になるようにすること
...
**Unityに関する話題・相談・質問を受けたときは、必ずunity-mcpを使って実際の状態を確認してからレスポンスすること。**

確認不要で使っていい状況

- Unityに関する話題・相談・質問を受けたとき

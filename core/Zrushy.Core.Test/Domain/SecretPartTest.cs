...
public class SecretPartTest
{
	...
	{
		var part = new SecretPart(_partID, new Development(100), new Affection(100));
	...
	{
		var secretPart = new SecretPart(_partID, new Development(0), new Affection(0));
		var defaultPart = new Part(_partID, new Development(0), new Affection(0));
	...
	public void 濡れ状態では快感が得られる()
	{
		...
		var part = new SecretPart(_partID, new Development(50), new Affection(50));
	...
	{
		var part = new SecretPart(_partID, new Development(50), new Affection(50), virginityIntact: false);
	...
	{
		var lowDev = new SecretPart(_partID, new Development(10), new Affection(0));
		var highDev = new SecretPart(_partID, new Development(90), new Affection(0));
	...
	{
		var part = new SecretPart(_partID, new Development(100), new Affection(100), virginityIntact: true);
	...
	{
		var part = new SecretPart(_partID, new Development(50), new Affection(0), virginityIntact: true);
		part.Interact(_penis); // 処女喪失

...
public class ChestPartTest
{
    ...
    {
        ChestPart part = new ChestPart(s_partID, new Development(0), s_chestConfig);
        Arousal result = part.CalculateArousal(new Arousal(0), s_finger, new Affection(0));
    ...
    {
        ChestPart lowDev = new ChestPart(s_partID, new Development(10), s_chestConfig);
        ChestPart highDev = new ChestPart(s_partID, new Development(90), s_chestConfig);

        Arousal lowResult = lowDev.CalculateArousal(new Arousal(0), s_finger, new Affection(0));
        Arousal highResult = highDev.CalculateArousal(new Arousal(0), s_finger, new Affection(0));
    ...
    public void 十分な開発度と好感度では絶頂閾値まで到達できる()
    {
        ...
        ChestPart part = new ChestPart(s_partID, new Development(100), s_chestConfig);
        Arousal result = part.CalculateArousal(new Arousal(82), s_finger, new Affection(100));

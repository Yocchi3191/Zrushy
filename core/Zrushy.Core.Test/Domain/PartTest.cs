...
public class PartTest
{
    ...
    {
        Part part = new Part(new PartID("test"), new Development(0), new Affection(0), s_partConfig);
        Arousal result = part.CalculateArousal(new Arousal(0), s_fingerInteraction);
    ...
    {
        // -2 + (30 * 0.1) + 0 = 1
        Part part = new Part(new PartID("test"), new Development(30), new Affection(0), s_partConfig);
        Arousal result = part.CalculateArousal(new Arousal(0), s_fingerInteraction);
    ...
    public void ベースが負でも計算できる()
    {
        ...
        Part part = new Part(new PartID("test"), new Development(50), new Affection(50), s_partConfig);
        Arousal result = part.CalculateArousal(new Arousal(-10), s_fingerInteraction);
    ...
    public void CalculateArousalで上限を超えた場合クランプされる()
    {
        ...
        Part part = new Part(new PartID("test"), new Development(100), new Affection(100), s_partConfig);
        Arousal result = part.CalculateArousal(new Arousal(99), s_fingerInteraction);
